<template>
    <div class="container">
      ...
      <div v-if="iban" class="iban-result">
        <label for="iban">IBAN:</label>
        <input type="text" id="iban" v-model="iban" readonly style="color: black;">
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
      async getIban() {
        ...
        try {
          const result = await customerStore.getIban(this.user.firstName, this.user.lastName);
          if (result.success) {
