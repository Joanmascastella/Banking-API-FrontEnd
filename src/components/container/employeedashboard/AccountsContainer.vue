<template>
  ...
  <b-button v-b-tooltip.hover title="Filter by absolute limit"  @click="filterAccounts"> <img
      id="absolute-limit-filter" src="../../../assets/img/filter-accounts.png"> </b-button>
...
<style scoped>
#absolute-limit-filter, #accounts-list {
  position: fixed;
  right: 0.5%;
  bottom: 7%;
